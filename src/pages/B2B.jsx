            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-40 mb-40 content-layer">
                <div className="reveal-item group">
                    <div className="aspect-[4/5] bg-surface overflow-hidden relative mb-8 rounded-2xl shadow-elevated group-hover:shadow-hover-glow transition-shadow duration-500">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-primary/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none mix-blend-multiply" />
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-20">
                    ...
                    <div className="md:w-2/3">
                        <form className="flex flex-col gap-12">
                            ...
                            <button className="self-start px-12 py-5 bg-primary text-white text-[10px] uppercase tracking-[0.2em] rounded-full hover:bg-black transition-all duration-500 ease-spring mt-8 shadow-lg hover:shadow-hover-glow hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary">
                                Отправить запрос
                            </button>
                        </form>
                    </div>
