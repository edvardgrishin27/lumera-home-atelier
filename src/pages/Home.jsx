        ...
        <div ref={containerRef} className="w-full bg-background overflow-hidden bg-noise">
            ...
            <section className="py-32 bg-surface min-h-[80vh] relative z-10">
                <div className="px-6 md:px-20 mb-16 flex flex-col md:flex-row justify-between items-end gap-8">
                    ...
                    <Link to="/catalog" className="flex items-center gap-4 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-full p-2 pr-4 transition-all hover:bg-black/5">
                        ...
                        <div className="w-10 h-10 border border-primary/20 rounded-full flex items-center justify-center group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all duration-300 ease-spring">
                            →
                        </div>
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-16 px-6 md:px-20">
                    {hitProducts.map((product, idx) => (
                        ...
                        >
                            ...
                            <div className="aspect-[4/5] overflow-hidden mb-6 bg-gray-50 relative rounded-xl shadow-elevated group-hover:shadow-floating transition-shadow duration-500">
                                <img
                                    src={product.image}
                                ...
                                <div className="absolute bottom-6 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-spring transform translate-y-4 group-hover:translate-y-0">
                                    <div className="bg-white/95 backdrop-blur-sm px-6 py-2 text-[10px] uppercase tracking-widest text-primary rounded-full shadow-lg whitespace-nowrap">
